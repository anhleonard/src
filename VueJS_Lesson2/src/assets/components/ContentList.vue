...
<div class="header">
    <div class="header__form">
          <div class="header__btn">
              <h4>ALL</h4>
              <font-awesome-icon  class="header__btn-icon" icon="fa-solid fa-angle-down" v-on:click="myFunction()"/>
          </div>
          <div class="header__list">
              <div class="header__item" v-for="bag in bags" v-bind:key="bag.id" v-on:click="getValue(bag)">
                  {{bag.title}}
              </div>
          </div>
    </div>
    <div class="main__wrapper">
        <div class="main__list-item">
            <div class="main__item" v-for="item in filterItems" v-bind:key="item.index">
...
export default {
    ...
    methods: {
        ...
        myFunction() {
            ...
            if(this.active === true) {
                var value = document.querySelector('.header__list');
